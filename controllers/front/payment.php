...
class WeArePlanetPaymentModuleFrontController extends WeArePlanetFrontpaymentcontroller
{
    ...
    public function initContent()
    {
        ...
        $showCart = Configuration::get(WeArePlanet::CK_SHOW_CART, null, null, $cart->id_shop);
        $showTos = Configuration::get(WeArePlanet::CK_SHOW_TOS, null, null, $cart->id_shop);

        $jsUrl = null;
        try {
            $jsUrl = WeArePlanetServiceTransaction::instance()->getJavascriptUrl($cart);
        } catch (Exception $e) {
            $this->context->cookie->pln_error = $this->module->l(
                'There was a technical issue, please try again.',
                'payment'
