...
class WeArePlanetBasemodule
{
    ...
    public static function getMailHookActiveWarning(WeArePlanet $module)
    {
        $output = "";
    ...
    public function hookActionOrderGridQueryBuilderModifier(WeArePlanet $module, $params) {
    ...
    public function hookActionOrderGridDefinitionModifier(WeArePlanet $module, $params) {
